...
\begin{solution}
	$A:=[0,1000]\cap \mathbb{N}, B:=\{a\in A: \exists b\in \mathbb{N}, b^2=a\}, C=\{a\in A: \exists b\in \mathbb{N}, b^3=a\}, D=B\cap C, E:=\{a\in A: \exists b\in \mathbb{N}, b^6=a\}$.
	 ...
	 While $|B|=|[1,1000^{1/2}]\cap \mathbb{N}|=31, |C|=|[1,1000^{1/3}]\cap \mathbb{N}|=10, |D|=|E|=|[1,1000^{1/6}]\cap \mathbb{N}|=3$. 
...
\begin{solution}
	...
	By the Inclusion-Exclusion Principle, $|A\minus (\cup_{i=1}^3B_i)|=|\{$ all of the arrangement of $\{4\cdot x, 3\cdot y, 2\cdot z\} $ that none of $xxxx,yyy,zz$ appears $\}|=|A|-(|B_1|+|B_2|+|B_3|)+(|B_{12}|+|B_{13}|+|B_{23}|)-|B_{123}|=\frac{9!}{4!3!2!}-(6\frac{5!}{3!2!}+7\frac{6!}{4!2!}+8\frac{7!}{4!3!})+(\frac{4!}{2!}+\frac{5!}{3!}+\frac{6!}{4!})-A_3^3=1260-(60+105+280)+(12+20+30)-6=871$.
\end{solution}
...
\end{problem}
\begin{solution}
	Since $20=2^2\times 5$, $105=3\times5\times7$, $210=2\times3\times5\times7$, so $\mu(20)=0,\mu(105)=-1,\mu(210)=1$.
\end{solution}
...
\begin{solution}
	\begin{equation}
		g(n)=\left\{
			...
			\end{array}\right.
	\end{equation}
When $n=1$, $\sum_{d|n}g(d)=g(1)=5$
$\forall n> 1$, $n=\prod_{i=1}^sp_i^{l_i}$, where $p_i$ is prime, $\forall i=1,\cdots, s$, $l_i\in \mathbb{N}_+$. So $\forall d|n$, $d> 1$, then $g(d)=0$, so $\sum_{i=1}^sg(d)=g(1)=5$.
\end{solution}
